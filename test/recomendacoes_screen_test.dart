...
import 'package:digital360_flutter/ui/screens/recomendacoes_screen.dart';
...
void main() {
  ...
  testWidgets('carrega e mostra as recomendacoes do mock (cold-start)', (tester) async {
    ...
    await tester.pumpWidget(
      MultiProvider(
        ...
        child: const MaterialApp(home: RecomendacoesScreen()),
      ),
    );

    // O carregamento e disparado via addPostFrameCallback (so roda depois do
    // 1o frame), entao o spinner so aparece a partir do 2o pump.
    await tester.pump();
    ...
    expect(find.textContaining('Sugestões calculadas pelo motor de recomendação'), findsOneWidget);
